  ...
  return (
    <div className='showcase-div'>
        <div className='cards-in-showcase-div'>
            ...
            <Card img='/pitcher.png' title='pitcher' titledate='pitch-training site!' button1='deployment 🧑🏻‍💻' button2='github 📂' href1='flos-frontend.vercel.app/' href2='github.com/eykyu-dev/flos-frontend'/>
